...
from tools.linkedin_tool import TOOLS as _LI_T, HANDLERS as _LI_H
from tools.instagram_tool import TOOLS as _IG_T, HANDLERS as _IG_H
...
ALL_TOOLS = (_SYS_T + _INP_T + _FIL_T + _SCR_T + _SPO_T + _BRW_T + _VIS_T
             + _HUE_T + _CC_T + _GMAIL_T + _CAL_T + _DISC_T + _WA_T + _LI_T + _IG_T + _MEM_T
             + _CC2_T + _TSK_T + _WCH_T + _CTX_T + _PLN_T + _CLN_T)
ALL_HANDLERS = {**_SYS_H, **_INP_H, **_FIL_H, **_SCR_H, **_SPO_H, **_BRW_H, **_VIS_H,
                **_HUE_H, **_CC_H, **_GMAIL_H, **_CAL_H, **_DISC_H, **_WA_H, **_LI_H, **_IG_H, **_MEM_H,
